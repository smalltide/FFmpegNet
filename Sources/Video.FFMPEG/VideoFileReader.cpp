...
void VideoFileReader::Open( String^ fileName )
{
	...
	try
	{
		...
		// OM (2013-05-31)
		// The documentation of nb_frames states: "number of frames in this stream if known or 0"
		// Going forward we could possibly calculate the number of frames via
		// duration (with pts) and r_frame_rate
