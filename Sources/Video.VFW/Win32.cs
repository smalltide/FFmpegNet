...
// Improvements by Ch. Fuchs 2012
// 
// API-functions, structures and enumerations are added,
// which are necassery for retriving VFW-CODECS
//
// they are marked with: ** New
//
// Refer to http://code.google.com/p/aforge/issues/detail?id=312
//
...
namespace AForge.Video.VFW
{
    ...
    internal static class Win32
    {
        ...
        //
        /// <summary>
        /// Provides access to the structures with infos about the installed VFW-Codecs
        /// </summary>
        /// 
        /// <param name="fccType">Integer, consisting of four Bytes, indicating the Uses Codec, "VIDC" for VideoStream.</param>
        /// <param name="fccHandler">Integer for counting the VFW-Codecs.</param>
        /// <param name="lpicinfo">Pointer to a ICINFO-structure with CODEC-Infos. Not all fields of the ICINFO-structure are filled after calling.</param>
        /// 
        /// <returns>Returns true if successful or false if no (further) codec(info) is found.</returns>
        /// 
        ...
        /// <summary>
        /// Returns a pointer, wich can be used to get more infos on a specific codec.
        /// </summary>
        /// 
        /// <param name="fccType">Integer, consisting of four Bytes, indicating the Uses Codec, "VIDC" for VideoStream.</param>
        /// <param name="fccHandler">Integer, consisting of four Bytes, indicating a specific VFW-Codecs. Get it from ICINFO.</param>
        /// <param name="wMode">Pointer to a ICMODE-structure (Use ICMODE_QUERY to get more Infos on a specific codec).</param>
        /// 
        /// <returns>Returns a pointer for the ICGetInfo-function or 0.</returns>
        /// 
        [DllImport("MSVFW32.dll"), PreserveSig]
        public static extern int ICOpen(int fccType, int fccHandler, ICMODE wMode);

        /// <summary>
        /// Closes the CODEC-Retrieve, opened with ICOpen, where the pointer hic is provided.
        /// </summary>
        /// 
        /// <param name="hic">Pointer from the ICOpen-function, for getting more infos on a specific codec.</param>
        /// 
        /// <returns>Returns 0 if successful or an error otherwise.</returns>
        /// 
        ...
        /// <summary>
        /// Provides all infos of specific codec in the ICINFO-structure.
        /// </summary>
        /// 
        /// <param name="hic">Pointer from the ICOpen-function, for getting more infos on a specific codec.</param>
        /// <param name="lpicinfo">Pointer to a ICINFO-structure, filled with all codec-information after calling the function</param>
        /// <param name="cb">Size of the ICINFO-structure.</param>
        /// 
        /// <returns>Returns 0 if successful or an error otherwise.</returns>
        /// 
        [DllImport("MSVFW32.dll", CharSet = CharSet.Ansi)]
        ...
        /// <summary>
        /// Structure, which contains information about a (video-)stream and how it is compressed and saved. 
        /// </summary>
        /// 
        ...
        public struct ICINFO
        {
            ...
            /// <summary>
            ///  Four-character code indicating the type of stream being compressed or decompressed. Use "VIDC" for video streams.
            /// </summary>
            /// 
            public int fccType;

            /// <summary>
            ///  A four-character code identifying a specific compressor, USE "DIB " for no compression.
            /// </summary>
            /// 
            public int fccHandler;

            /// <summary>
            ///  Applicable flags. Zero or more of the following flags can be set: eg.: VIDCF_COMPRESSFRAMES, VIDCF_CRUNCH, ...
            /// </summary>
            /// 
            public int dwFlags;
        ...
        /// <summary>
        /// FourCC for Videostreams
        /// </summary>
        /// 
        /// <returns>Returns a four-byte-integer ('vidc')indicating a videostream/codec.</returns>
        /// 
        public class VidFOURCC
        {
